...
public interface IEfdcFortranNativeDLL extends Library {
     ...
     */
    void m_openda_wrapper_init_(String modelInstanceParentDirPath,
                                 String modelTemplateDirPath,
                                 IntByReference modelInstanceParentDirPathLen,
                                 IntByReference modelTemplateDirPathLen);
     ...
     */
    int m_openda_wrapper_get_model_instance_(String modelInstancePath, IntByReference modelInstancePathLen);
