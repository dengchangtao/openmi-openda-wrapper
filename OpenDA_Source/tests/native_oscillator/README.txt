...
- OscillEnKFOpenDaConfig.oda   Run with ensemble Kalman filter and
...
- OscillSimplexOpenDaConfig.oda  Run with ensemble Kalman filter use
                                 observations from a java implementation of
                                 an observer that reads NOOS observations
                                 from the file obs_oscill.noos

- OscillEnKFOpenDaConfig_javaobs.oda Calibration run using the simplex method
