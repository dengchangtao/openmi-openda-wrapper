...
public class ThreadStochModelFactory implements IStochModelFactory{
    ...
    public IStochModelInstance getInstance(OutputLevel outputLevel) {
        ...
        IStochModelInstance newThreadModel = new ThreadStochModelInstance(childModelInstance, factoryID, maxThreads, cashState, nonBlockingAxpy);
