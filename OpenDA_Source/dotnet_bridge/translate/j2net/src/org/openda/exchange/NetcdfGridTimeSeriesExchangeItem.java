 ...
 * @author Arno Kockx
 */
public class NetcdfGridTimeSeriesExchangeItem implements IExchangeItem {
	private static final long serialVersionUID = 1790795730799681745L;
	...
	public void copyValuesFromItem(IExchangeItem sourceItem) {
		...
		this.netcdfDataObject.writeDataForExchangeItemForSingleTime(this, sourceTimeIndex, valuesForSourceTime);
	}

	public double[] getValuesForSingleTime(int timeIndex) {
		return this.netcdfDataObject.readDataForExchangeItemForSingleTime(this, this.timeDimensionIndex, timeIndex);
	}
}
