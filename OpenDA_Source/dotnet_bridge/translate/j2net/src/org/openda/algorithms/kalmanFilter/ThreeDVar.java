...
import org.openda.algorithms.SimpleCostFunction;
...
public class ThreeDVar extends AbstractSequentialAlgorithm{
	...
	public void analysis(IStochObserver observations, IVector obsValues, IVector predMainModel,
		...
		Results.putValue("x_f", mainModel.getState(), IResultWriter.MessageType.Step);
		Results.putValue("pred_f", predMainModel, IResultWriter.MessageType.Step);
		...
		Results.putValue("x_opt", mainModel.getParameters(), IResultWriter.MessageType.Step);
