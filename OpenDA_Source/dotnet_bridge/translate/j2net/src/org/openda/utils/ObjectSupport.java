...
public class ObjectSupport {
    ...
    public static IAlgorithm createAlgorithm(OpenDaComponentConfig algorithmConfiguration, IStochObserver stochObserver, IStochModelFactory stochModelFactory) {
