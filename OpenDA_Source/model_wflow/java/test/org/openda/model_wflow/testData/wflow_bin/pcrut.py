...
def rainfall_interception_gash(Cmax,EoverR,CanopyGapFraction, Precipitation):
    """
    Interception for daily timesteps according to the Gash model
    """
    ...
    return ThroughFall, Interception, StemFlow
