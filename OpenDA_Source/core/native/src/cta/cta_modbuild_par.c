/*
$URL: https://repos.deltares.nl/repos/openda/openda_1/public/trunk/core/native/src/cta/cta_modbuild_par.c $
$Revision: 3579 $, $Date: 2012-10-14 20:41:15 +0200 (zo, 14 okt 2012) $
...
void CTA_Modbuild_par_worker(){
   ...
   srand((long int) CTA_INITIAL_RANDOM_SEED);
