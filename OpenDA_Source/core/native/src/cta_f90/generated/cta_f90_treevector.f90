module cta_f90_treevector
  ...
  interface CTA_F90_TreeVector_SetVals
    module procedure CTA_TreeVector_SetVals_integer
    module procedure CTA_TreeVector_SetVals_real4
    module procedure CTA_TreeVector_SetVals_real8
  end interface
  ...
  interface CTA_F90_TreeVector_GetVals
    module procedure CTA_TreeVector_GetVals_integer
    module procedure CTA_TreeVector_GetVals_real4
    module procedure CTA_TreeVector_GetVals_real8
  end interface
...
contains
    ...
    subroutine CTA_TreeVector_SetConstant_integer( treevec, val, datatype, status )
      use CTA_F90_Parameters, only : CTA_HANDLE_IKIND
      integer(CTA_HANDLE_IKIND)     , intent(inout)     ::  treevec
      integer                       , intent(in   )     ::  val
      integer                       , intent(in   )     ::  datatype
      integer                       , intent(out  )     ::  status
      call CTA_TreeVector_SetConstant( treevec, val, datatype, status )
    end subroutine CTA_TreeVector_SetConstant_integer

    subroutine CTA_TreeVector_SetConstant_real4( treevec, val, datatype, status )
      use CTA_F90_Parameters, only : CTA_HANDLE_IKIND
      integer(CTA_HANDLE_IKIND)     , intent(inout)     ::  treevec
    ...
    subroutine CTA_TreeVector_SetConstant_real8( treevec, val, datatype, status )
      use CTA_F90_Parameters, only : CTA_HANDLE_IKIND
      integer(CTA_HANDLE_IKIND)     , intent(inout)     ::  treevec
    ...
    subroutine CTA_TreeVector_SetVals_integer( treevec, val, nval, datatype, status )
      use CTA_F90_Parameters, only : CTA_HANDLE_IKIND
      integer(CTA_HANDLE_IKIND)     , intent(inout)     ::  treevec
      integer                       , intent(in   )     ::  val(*)
      ...
      integer                       , intent(in   )     ::  datatype
      integer                       , intent(out  )     ::  status
      call CTA_TreeVector_SetVals( treevec, val, nval, datatype, status )
    end subroutine CTA_TreeVector_SetVals_integer

    subroutine CTA_TreeVector_SetVals_real4( treevec, val, nval, datatype, status )
      use CTA_F90_Parameters, only : CTA_HANDLE_IKIND
      integer(CTA_HANDLE_IKIND)     , intent(inout)     ::  treevec
      real(4)                       , intent(in   )     ::  val(*)
      integer                       , intent(in   )     ::  nval
      ...
      integer                       , intent(out  )     ::  status
      call CTA_TreeVector_SetVals( treevec, val, nval, datatype, status )
    end subroutine CTA_TreeVector_SetVals_real4

    subroutine CTA_TreeVector_SetVals_real8( treevec, val, nval, datatype, status )
      use CTA_F90_Parameters, only : CTA_HANDLE_IKIND
      integer(CTA_HANDLE_IKIND)     , intent(inout)     ::  treevec
      real(8)                       , intent(in   )     ::  val(*)
      integer                       , intent(in   )     ::  nval
      ...
      integer                       , intent(out  )     ::  status
      call CTA_TreeVector_SetVals( treevec, val, nval, datatype, status )
    end subroutine CTA_TreeVector_SetVals_real8

    subroutine CTA_TreeVector_GetVals_integer( treevec, val, nval, datatype, status )
      use CTA_F90_Parameters, only : CTA_HANDLE_IKIND
      integer(CTA_HANDLE_IKIND)     , intent(in   )     ::  treevec
      ...
      integer                       , intent(in   )     ::  datatype
      integer                       , intent(out  )     ::  status
      call CTA_TreeVector_GetVals( treevec, val, nval, datatype, status )
    end subroutine CTA_TreeVector_GetVals_integer

    subroutine CTA_TreeVector_GetVals_real4( treevec, val, nval, datatype, status )
      use CTA_F90_Parameters, only : CTA_HANDLE_IKIND
      integer(CTA_HANDLE_IKIND)     , intent(in   )     ::  treevec
      ...
      integer                       , intent(out  )     ::  status
      call CTA_TreeVector_GetVals( treevec, val, nval, datatype, status )
    end subroutine CTA_TreeVector_GetVals_real4

    subroutine CTA_TreeVector_GetVals_real8( treevec, val, nval, datatype, status )
      use CTA_F90_Parameters, only : CTA_HANDLE_IKIND
      integer(CTA_HANDLE_IKIND)     , intent(in   )     ::  treevec
      ...
      integer                       , intent(out  )     ::  status
      call CTA_TreeVector_GetVals( treevec, val, nval, datatype, status )
    end subroutine CTA_TreeVector_GetVals_real8

    subroutine CTA_TreeVector_SetVal_integer( treevec, i, val, datatype, status )
      use CTA_F90_Parameters, only : CTA_HANDLE_IKIND
      integer(CTA_HANDLE_IKIND)     , intent(inout)     ::  treevec
      integer                       , intent(in   )     ::  i
      integer                       , intent(in   )     ::  val
      integer                       , intent(in   )     ::  datatype
      integer                       , intent(out  )     ::  status
      call CTA_TreeVector_SetVal( treevec, i, val, datatype, status )
    end subroutine CTA_TreeVector_SetVal_integer

    subroutine CTA_TreeVector_SetVal_real4( treevec, i, val, datatype, status )
      use CTA_F90_Parameters, only : CTA_HANDLE_IKIND
      integer(CTA_HANDLE_IKIND)     , intent(inout)     ::  treevec
      integer                       , intent(in   )     ::  i
      real(4)                       , intent(in   )     ::  val
    ...
    subroutine CTA_TreeVector_SetVal_real8( treevec, i, val, datatype, status )
      use CTA_F90_Parameters, only : CTA_HANDLE_IKIND
      integer(CTA_HANDLE_IKIND)     , intent(inout)     ::  treevec
      integer                       , intent(in   )     ::  i
      real(8)                       , intent(in   )     ::  val
    ...
    subroutine CTA_TreeVector_GetVal_integer( treevec, i, val, datatype, status )
      use CTA_F90_Parameters, only : CTA_HANDLE_IKIND
      integer(CTA_HANDLE_IKIND)     , intent(in   )     ::  treevec
      integer                       , intent(in   )     ::  i
      integer                       , intent(out  )     ::  val
      integer                       , intent(in   )     ::  datatype
      integer                       , intent(out  )     ::  status
      call CTA_TreeVector_GetVal( treevec, i, val, datatype, status )
    end subroutine CTA_TreeVector_GetVal_integer

    subroutine CTA_TreeVector_GetVal_real4( treevec, i, val, datatype, status )
      use CTA_F90_Parameters, only : CTA_HANDLE_IKIND
      integer(CTA_HANDLE_IKIND)     , intent(in   )     ::  treevec
      integer                       , intent(in   )     ::  i
      real(4)                       , intent(out  )     ::  val
    ...
    subroutine CTA_TreeVector_GetVal_real8( treevec, i, val, datatype, status )
      use CTA_F90_Parameters, only : CTA_HANDLE_IKIND
      integer(CTA_HANDLE_IKIND)     , intent(in   )     ::  treevec
      integer                       , intent(in   )     ::  i
      real(8)                       , intent(out  )     ::  val
