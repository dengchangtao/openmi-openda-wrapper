module cta_f90_vector
  ...
  interface CTA_F90_Vector_GetVals
    module procedure CTA_Vector_GetVals_integer
    module procedure CTA_Vector_GetVals_real4
    module procedure CTA_Vector_GetVals_real8
  end interface
  ...
  !  \param status O error status: CTA_OK if successful
  !
  interface CTA_F90_Vector_AppendVal
    module procedure CTA_Vector_AppendVal_integer
    module procedure CTA_Vector_AppendVal_real4
    module procedure CTA_Vector_AppendVal_real8
  end interface
  ...
  interface CTA_F90_Vector_SetVals
    module procedure CTA_Vector_SetVals_integer
    module procedure CTA_Vector_SetVals_real4
    module procedure CTA_Vector_SetVals_real8
  end interface
...
contains
    ...
    subroutine CTA_Vector_GetVal_integer( hvec, i, vals, datatype, status )
      use CTA_F90_Parameters, only : CTA_HANDLE_IKIND
      integer(CTA_HANDLE_IKIND)     , intent(in   )     ::  hvec
      integer                       , intent(in   )     ::  i
      ...
      integer                       , intent(in   )     ::  datatype
      integer                       , intent(out  )     ::  status
      call CTA_Vector_GetVal( hvec, i, vals, datatype, status )
    end subroutine CTA_Vector_GetVal_integer

    subroutine CTA_Vector_GetVal_real4( hvec, i, vals, datatype, status )
      use CTA_F90_Parameters, only : CTA_HANDLE_IKIND
      integer(CTA_HANDLE_IKIND)     , intent(in   )     ::  hvec
      integer                       , intent(in   )     ::  i
    ...
    subroutine CTA_Vector_GetVal_real8( hvec, i, vals, datatype, status )
      use CTA_F90_Parameters, only : CTA_HANDLE_IKIND
      integer(CTA_HANDLE_IKIND)     , intent(in   )     ::  hvec
      integer                       , intent(in   )     ::  i
    ...
    subroutine CTA_Vector_GetVals_integer( hvec, vals, n, datatype, status )
      use CTA_F90_Parameters, only : CTA_HANDLE_IKIND
      integer(CTA_HANDLE_IKIND)     , intent(in   )     ::  hvec
      integer                       , intent(out  )     ::  vals(*)
      integer                       , intent(in   )     ::  n
      integer                       , intent(in   )     ::  datatype
      integer                       , intent(out  )     ::  status
      call CTA_Vector_GetVals( hvec, vals, n, datatype, status )
    end subroutine CTA_Vector_GetVals_integer

    subroutine CTA_Vector_GetVals_real4( hvec, vals, n, datatype, status )
      use CTA_F90_Parameters, only : CTA_HANDLE_IKIND
      integer(CTA_HANDLE_IKIND)     , intent(in   )     ::  hvec
      real(4)                       , intent(out  )     ::  vals(*)
      integer                       , intent(in   )     ::  n
      ...
      integer                       , intent(out  )     ::  status
      call CTA_Vector_GetVals( hvec, vals, n, datatype, status )
    end subroutine CTA_Vector_GetVals_real4

    subroutine CTA_Vector_GetVals_real8( hvec, vals, n, datatype, status )
      use CTA_F90_Parameters, only : CTA_HANDLE_IKIND
      integer(CTA_HANDLE_IKIND)     , intent(in   )     ::  hvec
      real(8)                       , intent(out  )     ::  vals(*)
      integer                       , intent(in   )     ::  n
      ...
      integer                       , intent(out  )     ::  status
      call CTA_Vector_GetVals( hvec, vals, n, datatype, status )
    end subroutine CTA_Vector_GetVals_real8

    subroutine CTA_Vector_SetVal_integer( hvec, i, val, datatype, status )
      use CTA_F90_Parameters, only : CTA_HANDLE_IKIND
      integer(CTA_HANDLE_IKIND)     , intent(inout)     ::  hvec
      integer                       , intent(in   )     ::  i
      ...
      integer                       , intent(in   )     ::  datatype
      integer                       , intent(out  )     ::  status
      call CTA_Vector_SetVal( hvec, i, val, datatype, status )
    end subroutine CTA_Vector_SetVal_integer

    subroutine CTA_Vector_SetVal_real4( hvec, i, val, datatype, status )
      use CTA_F90_Parameters, only : CTA_HANDLE_IKIND
      integer(CTA_HANDLE_IKIND)     , intent(inout)     ::  hvec
      integer                       , intent(in   )     ::  i
    ...
    subroutine CTA_Vector_SetVal_real8( hvec, i, val, datatype, status )
      use CTA_F90_Parameters, only : CTA_HANDLE_IKIND
      integer(CTA_HANDLE_IKIND)     , intent(inout)     ::  hvec
      integer                       , intent(in   )     ::  i
    ...
    subroutine CTA_Vector_AppendVal_integer( hvec, val, datatype, status )
      use CTA_F90_Parameters, only : CTA_HANDLE_IKIND
      integer(CTA_HANDLE_IKIND)     , intent(inout)     ::  hvec
      integer                       , intent(in   )     ::  val
      integer                       , intent(in   )     ::  datatype
      integer                       , intent(out  )     ::  status
      call CTA_Vector_AppendVal( hvec, val, datatype, status )
    end subroutine CTA_Vector_AppendVal_integer

    subroutine CTA_Vector_AppendVal_real4( hvec, val, datatype, status )
      use CTA_F90_Parameters, only : CTA_HANDLE_IKIND
      integer(CTA_HANDLE_IKIND)     , intent(inout)     ::  hvec
      real(4)                       , intent(in   )     ::  val
      integer                       , intent(in   )     ::  datatype
      integer                       , intent(out  )     ::  status
      call CTA_Vector_AppendVal( hvec, val, datatype, status )
    end subroutine CTA_Vector_AppendVal_real4

    subroutine CTA_Vector_AppendVal_real8( hvec, val, datatype, status )
      use CTA_F90_Parameters, only : CTA_HANDLE_IKIND
      integer(CTA_HANDLE_IKIND)     , intent(inout)     ::  hvec
      real(8)                       , intent(in   )     ::  val
      integer                       , intent(in   )     ::  datatype
      integer                       , intent(out  )     ::  status
      call CTA_Vector_AppendVal( hvec, val, datatype, status )
    end subroutine CTA_Vector_AppendVal_real8

    subroutine CTA_Vector_SetVals_integer( hvec, vals, n, datatype, status )
      use CTA_F90_Parameters, only : CTA_HANDLE_IKIND
      integer(CTA_HANDLE_IKIND)     , intent(inout)     ::  hvec
      ...
      integer                       , intent(in   )     ::  datatype
      integer                       , intent(out  )     ::  status
      call CTA_Vector_SetVals( hvec, vals, n, datatype, status )
    end subroutine CTA_Vector_SetVals_integer

    subroutine CTA_Vector_SetVals_real4( hvec, vals, n, datatype, status )
      use CTA_F90_Parameters, only : CTA_HANDLE_IKIND
      integer(CTA_HANDLE_IKIND)     , intent(inout)     ::  hvec
      ...
      integer                       , intent(out  )     ::  status
      call CTA_Vector_SetVals( hvec, vals, n, datatype, status )
    end subroutine CTA_Vector_SetVals_real4

    subroutine CTA_Vector_SetVals_real8( hvec, vals, n, datatype, status )
      use CTA_F90_Parameters, only : CTA_HANDLE_IKIND
      integer(CTA_HANDLE_IKIND)     , intent(inout)     ::  hvec
      ...
      integer                       , intent(out  )     ::  status
      call CTA_Vector_SetVals( hvec, vals, n, datatype, status )
    end subroutine CTA_Vector_SetVals_real8

    subroutine CTA_Vector_SetConstant_integer( hvec, val, datatype, status )
      use CTA_F90_Parameters, only : CTA_HANDLE_IKIND
      integer(CTA_HANDLE_IKIND)     , intent(inout)     ::  hvec
      integer                       , intent(in   )     ::  val
      integer                       , intent(in   )     ::  datatype
      integer                       , intent(out  )     ::  status
      call CTA_Vector_SetConstant( hvec, val, datatype, status )
    end subroutine CTA_Vector_SetConstant_integer

    subroutine CTA_Vector_SetConstant_real4( hvec, val, datatype, status )
      use CTA_F90_Parameters, only : CTA_HANDLE_IKIND
      integer(CTA_HANDLE_IKIND)     , intent(inout)     ::  hvec
      real(4)                       , intent(in   )     ::  val
      integer                       , intent(in   )     ::  datatype
    ...
    subroutine CTA_Vector_SetConstant_real8( hvec, val, datatype, status )
      use CTA_F90_Parameters, only : CTA_HANDLE_IKIND
      integer(CTA_HANDLE_IKIND)     , intent(inout)     ::  hvec
      real(8)                       , intent(in   )     ::  val
      integer                       , intent(in   )     ::  datatype
