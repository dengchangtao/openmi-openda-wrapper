 ...
 * \return no return value
 */
void CTAI_SObs_netcdf_Count( CTAI_SObs_netcdf *x, int *nmeasr,
       int *retval);
 ...
 * \return no return value
 */
void CTAI_SObs_netcdf_GetVals( CTAI_SObs_netcdf *x, CTA_Vector *hvec,
       int *retval);
 ...
 * \return no return value
 */
void CTAI_SObs_netcdf_GetTimes( CTAI_SObs_netcdf *x, CTA_Vector *hvec,
       int *retval);
 ...
 * \return no return value
 */
void CTAI_SObs_netcdf_GetCovMat( CTAI_SObs_netcdf *x, CTA_Matrix *hmat,
       int *retval);
 ...
 * \return no return value
 */
void CTAI_SObs_netcdf_export( CTAI_SObs_netcdf *x, CTA_Handle *userdata,
       int *retval);
