!
! $URL: https://repos.deltares.nl/repos/openda/openda_1/public/trunk/core/native/examples/oscill/src/oscill.f90 $
! $Revision: 1445 $, $Date: 2010-04-09 10:57:43 +0200 (vr, 09 apr 2010) $
!
...
!  make metainfo; such that the ar1 model and this model can recognize their states
   ...
   call oscill_model_setgrid(state, ierr)
