...
\begin{vtlogsheet}
\vtlogentry{1.0}{CvV}{2006-12-01}{Initial version}{}
\vtfilelocation{$<$COSTA\_DIR$>$/doc/model\_builders/m06006\_modbuild\_par}
\end{vtlogsheet}
...
\begin{figure}
\hbox{\epsfig{figure=\figs/oscil_1_cpu.\pdfeps,width=7cm}
      \epsfig{figure=\figs/oscil_10_cpu.\pdfeps,width=7cm}}
...
\begin{figure}
\hbox{\epsfig{figure=\figs/aster_30_24.\pdfeps,width=7cm}
      \epsfig{figure=\figs/aster_30_24_su.\pdfeps,width=7cm}}
...
\begin{figure}
\hbox{\epsfig{figure=\figs/aster_60_24.\pdfeps,width=7cm}
      \epsfig{figure=\figs/aster_60_24_su.\pdfeps,width=7cm}}
