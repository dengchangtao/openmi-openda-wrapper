...
%Typically you have your model configuration file(s) in a directory called {\tt model} relative main {\tt oda} file. When you place both (thread and back-end) model configuration files in the directory model you have to fill in 
%\begin{verbatim}
%<workingDirectory>model</workingDirectory>
%\end{verbatim}
