...
#define CTA_MODEL_SAVEINTERNALSTATE         (30)
#define CTA_MODEL_RESTOREINTERNALSTATE      (31)
#define CTA_MODEL_RELEASEINTERNALSTATE      (32)
#define CTA_MODEL_SAVEPERSISTENTSTATE       (33)
#define CTA_MODEL_LOADPERSISTENTSTATE       (29)
