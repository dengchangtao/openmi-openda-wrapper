        ...
        if (currentModelInstance instanceof IStochModelInstance) {
            ...
            if (currentModelInstance instanceof SwanCalibWrapper) {
                ...
                if (firstInstance) {
                    ...
                    String parametersFileName = swivtParametersFile.getName();
                    SwivtParametersResultWriter resultWriter = new SwivtParametersResultWriter(
                            swivtParametersFile.getParentFile().getParentFile(), parametersFileName);
					//TODO (JHS): check if the code below is actually needed. The code below does not go along with the
					//newly made results selection. As a temporary work around, I simply disactivate the code.
                    //Results.addResultWriter(resultWriter, new ResultSelectionConfig("pOpt"));
                }
