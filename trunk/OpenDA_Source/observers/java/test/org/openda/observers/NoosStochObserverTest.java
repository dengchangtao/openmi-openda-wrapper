...
public class NoosStochObserverTest extends TestCase {
	...
	public void testStochObserver_1() {
		...
		assertEquals(-902678972,obs1String.hashCode());
		...
		n = propNames.length;
		assertEquals("descr1.getPropertyKeys().length",12,n);
	...
	public void testStochObserver_2() {
		...
		String obs1String = obs1.toString();
		System.out.println("obs1="+obs1String);
		assertEquals(-1135247117,obs1String.hashCode());
	...
	public void testStochObserver_missingData() {
		...
		System.out.println("obs2="+obs2String);
		assertEquals(385992580,obs2String.hashCode());
