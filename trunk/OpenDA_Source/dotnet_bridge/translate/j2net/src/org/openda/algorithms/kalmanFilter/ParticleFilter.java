...
public class ParticleFilter extends AbstractSequentialEnsembleAlgorithm {
	...
	public IModelState loadPersistentState(File algorithmStateFile) {
		throw new UnsupportedOperationException("org.openda.algorithms.kalmanFilter.ParticleFilter.loadPersistentState(): Not implemented yet.");
	}
	...
	public void analysis(IStochObserver stochObserver, IVector obsValues, IVector predMainModel, 
		...
		Results.putValue("weights", new Vector(normalizedWeightsAllObservations), IResultWriter.MessageType.Step);
		...
		Results.putValue("stdx_a", xiStd, IResultWriter.MessageType.Step);
	...
	private int[] residualResampling(double[] normalizedWeights){
		...
		Results.putValue("resamplingIndices",new Vector(result), IResultWriter.MessageType.Step);
