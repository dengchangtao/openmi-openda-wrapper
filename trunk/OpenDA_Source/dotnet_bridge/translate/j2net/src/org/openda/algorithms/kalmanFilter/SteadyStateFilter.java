...
public class SteadyStateFilter extends AbstractSequentialAlgorithm {
	...
	public void initialize(File workingDir, String[] arguments) {
		...
		gainStorage.readKalmanGain( this.currentState);
	...
	public void analysis(IStochObserver observations, IVector obsValues, IVector predictions,
		...
		// x_a = x_f + K(y-H x_f)
		IVector x = this.currentState;
		IVector delta = x.clone(); //vector of same type; content is overwritten
		delta.scale(0.0);
		
		Results.putValue("x_f", x, IResultWriter.MessageType.Step);
		Results.putValue("pred_f", predictions, IResultWriter.MessageType.Step);
		...
		Results.putValue("pred_a", pred_a, IResultWriter.MessageType.Step);
