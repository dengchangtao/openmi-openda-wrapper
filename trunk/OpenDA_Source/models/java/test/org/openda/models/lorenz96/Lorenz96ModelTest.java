...
//        algorithm.run();
    ...
    public static void testLorenzModel_13() {
        ...
        String correctSample = "[5.040116245421077,4.6853598680203135,4.227241813491862,3.752178717638764,3.3309235407207516,3.0032322727417293,2.770704510130689,2.600288645712636,2.436956297999765,2.2205599573551678,...,-3.235732376576145,-1.9117453113355725,-0.5415806750252159,0.8088771891673672,2.0749481698749106,3.1930500286874643,4.103377927159379,4.756861677913568,5.124863230005772,5.207979566033629]";
        System.out.println("Should be xSample ="+correctSample);
        assertEquals("xSample", sampleState.toString(), correctSample);        
    }
