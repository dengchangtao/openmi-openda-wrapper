...
public class River1ModelTest extends TestCase {
    ...
    public static void testRiver1ModelTest_2() {
        ...
        assertEquals("mod2.getState()[0]",1.10,x.getValue(0),0.001);
        assertEquals("mod2.getState()[1]",2.33,x.getValue(1),0.001);
        ...
        // exact answer is: 1.05 and 2.465
        assertEquals("mod2.getState()[0]",1.05,x.getValue(0),0.001);
        assertEquals("mod2.getState()[1]",2.465,x.getValue(1),0.001);
