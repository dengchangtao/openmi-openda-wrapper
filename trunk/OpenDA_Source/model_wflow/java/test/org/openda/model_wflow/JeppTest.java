 ...
 * PATH: folder with jep.dll file (e.g. openda_bin\win32_ifort).
 *
 * @author Arno Kockx
 */
public class JeppTest extends TestCase {
	 ...
	 */
	//TODO linux
	public void manualTestPythonScript() throws JepException {
	 ...
	 * @throws JepException
	 */
	public void manualTestPythonFunction() throws JepException {
		//new Jep(boolean interactive, String includePath, ClassLoader classLoader). 
		Jep jep = new Jep(false, testRunDataDir.getAbsolutePath() + "/jeppTest/pythonScripts");
