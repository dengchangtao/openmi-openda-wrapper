...
def configget(config,section,var,default):
    ...
    the key is not found. If the key is not found it also set the value 
    with the default
...
def detdrainwidth(ldd,xl,yl):
    """
    Determines width of driange over DEM for a non square grid
