...
call :run_single_test OscillEnKFOpenDaConfig         EnKF-results.txt    
call :run_single_test OscillEnKFOpenDaConfig_javaobs EnKF-results.txt
call :run_single_test OscillSimplexOpenDaConfig      Simplex-results.txt
