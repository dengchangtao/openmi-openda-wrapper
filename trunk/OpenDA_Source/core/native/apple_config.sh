...
./configure  -with-netcdf=/Users/nils/Devel/opt CFLAGS='-Wall -O0 -g' FCFLAGS='-Wall -O0 -g' CXXFLAGS='-Wall -O0 -g' FFLAGS='-Wall -O0 -g'   CPPFLAGS=-I/Developer/SDKs/MacOSX10.6.sdk/System/Library/Frameworks/JavaVM.framework/Versions/1.6.0/Headers --with-netcdf=/Users/nils/Devel/opt-4.6.3/netcdf-4.2
