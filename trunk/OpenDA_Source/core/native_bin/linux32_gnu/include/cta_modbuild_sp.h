...
void modbuild_sp_ar1_create(CTA_Handle *hinput, CTA_TreeVector *state, CTA_TreeVector *sbound, 
...
void modbuild_sp_ar1_compute(CTA_Time *timesspan,CTA_TreeVector *state, CTA_TreeVector *saxpyforc,
