...
!! Module for storing and switching the EFDC state for each instance.
!! 
!!
  ...
  ! water quality
  integer, parameter :: Grid_AlgalCyanobacteria      = 1501
  integer, parameter :: Grid_AlgalDiatom             = 1502
  integer, parameter :: Grid_AlgalGreenAlgae         = 1503
  integer, parameter :: Grid_RefractoryPOCarbon      = 1504
  integer, parameter :: Grid_LabilePOCarbon          = 1505
  integer, parameter :: Grid_DissolvedOCarbon        = 1506
  integer, parameter :: Grid_RefractoryPOPhosphorus  = 1507
  integer, parameter :: Grid_LabilePOPhosporus       = 1508
  integer, parameter :: Grid_DissolvedOPhosphorus    = 1509
  integer, parameter :: Grid_Phosphate               = 1510
  integer, parameter :: Grid_RefractoryPONitrogen    = 1511
  integer, parameter :: Grid_LabilePONitrogen        = 1512
  integer, parameter :: Grid_DissolvedONitrogen      = 1513
  integer, parameter :: Grid_Ammonia                 = 1514
  integer, parameter :: Grid_Nitrate                 = 1515
  integer, parameter :: Grid_DisolvedOxygen          = 1519
